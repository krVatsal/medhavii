        ...
        <div className="max-w-md w-full">
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 text-center">
            ...
            <div className="mb-6">
              ...
              />
              <h2 className="text-2xl font-bold bg-gradient-to-r from-orange-600 via-green-600 to-blue-600 bg-clip-text text-transparent mb-2">
                Medhavi
              </h2>
              <div className="w-16 h-1 bg-gradient-to-r from-orange-500 via-green-500 to-blue-600 mx-auto rounded-full"></div>
            </div>

...
from api.v1.ppt.endpoints.groq import GROQ_ROUTER
...
from api.v1.ppt.endpoints.quiz import QUIZ_ROUTER
...
API_V1_PPT_ROUTER.include_router(GROQ_ROUTER)
...
API_V1_PPT_ROUTER.include_router(QUIZ_ROUTER)
